	...
	$("#goal-thermometer").html(
		...
		"<div id='therm-graphics'>" + 
			...
			"<div id='therm-tooltip'>" + 
				...
				"<div class='tip-middle'><p style='color: #fff'>$0</p></div>" +
